...
public class ElementLocatorModel
{
    public static WebElement findElementById(String id) {
        return ChromeDriverController.getWebDriver().findElement(By.id(id));
    }
    ...
    public static WebElement findElementByClassName(String className) {
        return ChromeDriverController.getWebDriver().findElement(By.className(className));
    }
    ...
    public static List<WebElement> findElementsByClassName(String className) {
        return ChromeDriverController.getWebDriver().findElements(By.className(className));
    }
    ...
    public static WebElement findElementByTagName(String tagName) {
        return ChromeDriverController.getWebDriver().findElement(By.tagName(tagName));
    }
    ...
    public static List<WebElement> findElementsByTagName(String tagName) {
        return ChromeDriverController.getWebDriver().findElements(By.tagName(tagName));
    }
    ...
    public static WebElement findElementByXPath(String xpath) {
        return ChromeDriverController.getWebDriver().findElement(By.xpath(xpath));
    }
    ...
    public static List<WebElement> findElementsByXPath(String xpath) {
        return ChromeDriverController.getWebDriver().findElements(By.xpath(xpath));
    }
